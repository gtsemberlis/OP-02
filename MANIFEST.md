...
| Canonical reference | Object type | Status | Source path |
|---|---|---|---|
| A-A | Appendix | Draft | `appendices/A-A-master-timeline.md` |
| A-B | Appendix | Draft | `appendices/A-B-evidence-matrix.md` |
| A-C | Appendix | Draft | `appendices/A-C-handout-historical-artifact-index.md` |
...
| L-04 | Location | Draft | `locations/L-04-ntsb-field-office.md` |
| L-05 | Location | Draft | `locations/L-05-program-secure-briefing-facility.md` |
| N-01 | NPC | Draft | `npcs/N-01-michael-havel.md` |
| N-02 | NPC | Draft | `npcs/N-02-ethan-mercer.md` |
| N-03 | NPC | Draft | `npcs/N-03-dr-ananya-rao.md` |
| N-04 | NPC | Draft | `npcs/N-04-kevin-park.md` |
| N-05 | NPC | Draft | `npcs/N-05-javier-ortiz.md` |
...
| FM-PUB | Front Matter | Canonical | `publication/FM-PUB-publication-information.md` |
| FM-REFERENCES | Front Matter | Canonical | `publication/FM-REFERENCES-canonical-reference-system.md` |
| FM-RELEASE | Front Matter | Canonical | `publication/FM-RELEASE-canonical-release-declaration.md` |
| FM-TOC | Front Matter | Draft | `publication/FM-TOC-table-of-contents.md` |
| FM-USAGE | Front Matter | Canonical | `publication/FM-USAGE-how-to-use-this-book.md` |
| OP-01 | Publication | Canonical | `publication/OP-01-operation-airspace.md` |
| S-01 | Scene | Draft | `scenes/S-01-cold-open-o-hare.md` |
| S-02 | Scene | Draft | `scenes/S-02-program-briefing.md` |
| S-03 | Scene | Draft | `scenes/S-03-institutional-coordination.md` |
| S-04 | Scene | Draft | `scenes/S-04-alexandria-systems-review.md` |
| S-05 | Scene | Draft | `scenes/S-05-independent-analysis.md` |
| S-06 | Scene | Draft | `scenes/S-06-independent-witnesses.md` |
